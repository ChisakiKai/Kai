...
import KaiRoboto.modules.sql.welcome_sql as sql
import KaiRoboto
...
from KaiRoboto.modules.helper_funcs.msg_types import get_welcome_type
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text(
                    "I'm coming!", reply_to_message_id=reply
                )
                continue
